...
public class GoogleMobileAdsHandler: MonoBehaviour
{
	...
	public string AdmobInterstitialAndroidId,AdmobInterstitialIosId,displayingText;
    ...
    public void RequestInterstitial()
    {
        ...
        string adUnitId = "unused";
        #elif UNITY_ANDROID
		string adUnitId = AdmobInterstitialAndroidId;
        #elif UNITY_IPHONE
		string adUnitId = AdmobInterstitialIosId;
        #else
        string adUnitId = "unexpected_platform";
        #endif
    ...
    public void HandleInterstitialLoaded(object sender, EventArgs args)
    {
		...
		displayingText = "HandleInterstitialLoaded event received";
    }
    ...
    public void HandleInterstitialFailedToLoad(object sender, AdFailedToLoadEventArgs args)
    {
		...
		displayingText = "HandleInterstitialFailedToLoad event received with message: " + args.Message;
    }

    public void HandleInterstitialOpened(object sender, EventArgs args)
    {
        MonoBehaviour.print("HandleInterstitialOpened event received");
		displayingText = "HandleInterstitialOpened event received";
    }

    public void HandleInterstitialClosed(object sender, EventArgs args)
    {
        MonoBehaviour.print("HandleInterstitialClosed event received");
		displayingText = "HandleInterstitialClosed event received";
    }

    public void HandleInterstitialLeftApplication(object sender, EventArgs args)
    {
        MonoBehaviour.print("HandleInterstitialLeftApplication event received");
		displayingText = "HandleInterstitialLeftApplication event received";
    }
